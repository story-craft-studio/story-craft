...
export interface Passage {
	...
	width: number;
	/**
	 * Random pastel color assigned to this passage.
	 */
	color?: string;
}
...
export interface Story {
	...
	/**
	 * Path to the template file (if this is a template story)
	 */
	templatePath?: string;

	/**
	 * Whether remixing is enabled for the story.
	 */
...
export interface ArchiveStoryAction {
	type: 'archiveStory';
	storyId: string;
}

export interface UnarchiveStoryAction {
	type: 'unarchiveStory';
	storyId: string;
}
...
export type StoriesDispatch = React.Dispatch<
	StoriesAction | typeof Thunk<StoriesState, StoriesAction>
>;
