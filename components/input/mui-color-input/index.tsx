...
import ColorPopoverBody from './ColorPopoverBody/ColorPopoverBody'
import ColorTextField from './ColorTextField/ColorTextField'
import { FORMAT_FALLBACK } from './constants/fallback'
import {
...
export const MuiColorInput = React.forwardRef(
	(
		{
			value,
			format,
